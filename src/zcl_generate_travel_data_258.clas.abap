CLASS zcl_generate_travel_data_258 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_generate_travel_data_258 IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.

    DATA itab TYPE TABLE OF ztravel_258.
...
*   delete existing entries in the database table
    DELETE FROM ztravel_258.

*   insert the new table entries
    INSERT ztravel_258 FROM TABLE @itab.
